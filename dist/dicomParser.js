...
var dicomParser = (function(dicomParser) {
    ...
    dicomParser.parseDicom = function(byteArray, options) {
        ...
        function readTransferSyntax(metaHeaderDataSet) {
			//zssure:2017.11.01
			//ignore the dicom file which has no metainformaiton
			if(metaHeaderDataSet == null)
        ...
        function readDataSet(metaHeaderDataSet)
        {
            ...
            var dataSetByteStream = getDataSetByteStream(transferSyntax, metaHeaderDataSet!=null?metaHeaderDataSet.position:0);
...
var dicomParser = (function(dicomParser) {
  ...
  dicomParser.readPart10Header = function(byteArray, options) {
    ...
    function readPrefix()
    {
	  ...
	  if(littleEndianByteStream.byteArray[0]!=0)
		  return;
	  //zssure:2017.11.01 end 
